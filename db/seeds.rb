...
# Creating books
Book.create(title: "Harry Potter: Philosopher's Stone", description: "The exciting beginning of a world full of magic, adventure, and friendship. Until his eleventh birthday, Harry believes he is a completely normal boy. But then he learns that he is to attend the School of Witchcraft and Wizardry because he is a wizard!", author: "Rowling J.K.", category: category1, user: user1, cover: "https://en.wikipedia.org/wiki/Harry_Potter_and_the_Philosopher%27s_Stone#/media/File:Harry_Potter_and_the_Philosopher's_Stone_Book_Cover.jpg")
